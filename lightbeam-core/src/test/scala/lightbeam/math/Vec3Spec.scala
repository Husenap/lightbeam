  ...
  "A Vec3" when {
    "immutable" should {
      ...
      "be divisible by a scalar" in {
        ...
        v1 / 5 shouldBe Vec3(0.2, 0.4, 0.6)
      }
      ...
      "have a magnitude" in {
        ...
        Vec3(1, 2, 3).magnitude shouldBe 3.74 +- 0.01
    ...
    "mutable" should {
      "be commutatively additive" in {
        ...
        v1 += v2
        v1 shouldBe Vec3(5, 7, 9)

        v1 += 5
        v1 shouldBe Vec3(10, 12, 14)

        v2 += -2
        v2 shouldBe Vec3(2, 3, 4)
      }
      ...
      "be multipliable by a scalar" in {
        ...
        v1 *= 5
        v1 shouldBe Vec3(5, 10, 15)

        v1 *= 3
        v1 shouldBe Vec3(15, 30, 45)
      }
      ...
      "be divisible by a scalar" in {
        ...
        v1 /= 5
        v1 shouldBe Vec3(0.2, 0.4, 0.6)
      }

      "be normalizable" in {
        val v1 = Vec3(42, 0, 0)
        v1.normalize()
        v1 shouldBe Vec3(1, 0, 0)
      }
    }
  }
